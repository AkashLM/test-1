...
const Card = () => {
  return (
    <div className="flex justify-start text-white align-middle">
      <div className="group max-w-[375px]">
        <div className="text-left m-4 p-3 bg-[#212121] rounded-2xl ">
          <div className="relative top-[-20px] isolate">
            ...
            <Image
              src={dash1}
              alt="nft"
              className="group-hover:scale-105 mb-[-10px] ease-in-out duration-1000 flex rounded-xl justify-center align-middle h-[30vh] object-cover"
            />
          </div>
          <div className="text-xl mb-3">Pinko take care</div>
          <div className="text-[#9D9D9D] text-sm mb-3">
            Being a family to us means protecting and supporting each other,
            taking care of the people around us, accepting the others.
          </div>
      ...
      <div className="group max-w-[375px]">
        <div className="text-left m-4 p-3 bg-[#212121] rounded-2xl ">
          ...
          <div className="text-xl mb-3">
            #Pinkotakecarechronicles: 6 pinkoctober
          </div>

          <div className="text-[#9D9D9D] text-sm mb-5">
            October is Breast Cancer Awareness Month, and #PINKOtakecare is in
            the front line!
          </div>
      ...
      <div className="group max-w-[375px]">
        <div className="text-left m-4 p-3 bg-[#212121] rounded-2xl ">
          ...
          <div className="text-xl mb-3">Keep in touch, 10% off!</div>
          <div className="text-[#9D9D9D] text-sm mb-3">
            The new arrivals are also waiting for you in Store and online.Come
            take a look at them with 10% off of your first purchase!
          </div>
          <button className="p-2 w-full font-[Raleway] rounded-full font-bold bg-white text-black">
            Subscribe
          </button>
