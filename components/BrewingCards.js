      ...
      lastComp: (
        <div className='flex justify-between'>
          <div className='flex items-center cursor-pointer'>
            <svg
              className='fill-transparent mr-[.3rem] md:mr-2 hover:fill-[#BF286F]'
              width='23'
              height='18'
              viewBox='0 0 23 18'
            ...
            <p className='text-[12px] md:text-base'>Like</p>
          </div>
          <div className='flex items-center cursor-pointer'>
            <svg
              width='22'
            ...
            <p className='text-[12px] md:text-base'>43 Comments</p>
          </div>
          <div className='flex items-center cursor-pointer'>
            <svg
              width='22'
            ...
            <p className='text-[12px] md:text-base'>Share</p>
          </div>
        </div>
      ),
    },
